...
class FuzzyDecisionTableGenerator:
    ...
    def __init__(self, X: pd.DataFrame, y: pd.Series, fuzzy_sets, clauses, target_label: str = 'Decision'):
        """
        ...
        self.__features_clauses = clauses
        self.__target_label = target_label
        self.__dataset = X.copy()
    ...
    def __get_highest_membership(self, feature: str, crisp: float) -> str:
        ...
        for clause in list(self.__features_clauses[feature].values()):
